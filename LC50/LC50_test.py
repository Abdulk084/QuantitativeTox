...
members = [model_fp_loaded, model_graph_loaded, model_desc_loaded,  model_fv_loaded]
...
pred_test_ext_stack_load =  model_stack .predict([X_test_ext_fp, [x_test_ext_gc, A_test_ext_gc],
                                       ...
                                       X_test_ext_desc_norm,  X_test_ext_fv ])
...
pred_test_ext_stack_load = np.squeeze(pred_test_ext_stack_load[1][1833:1997])


test_ext_LC50_meta_r2 = np.array([test_ext_LC50_meta_r2])


test_ext_LC50_meta_mae = np.array([test_ext_LC50_meta_mae])


test_ext_LC50_meta_rmse = np.array([test_ext_LC50_meta_rmse])
...
pd.concat([
    ...
    pd.DataFrame(pred_test_ext_stack_load, columns=['pred_test_ext_stack_load_LC50']),

    pd.DataFrame(test_ext_LC50_meta_r2, columns=['test_ext_LC50_meta_r2']),

    pd.DataFrame(test_ext_LC50_meta_mae, columns=['test_ext_LC50_meta_mae']),

    pd.DataFrame(test_ext_LC50_meta_rmse, columns=['test_ext_LC50_meta_rmse'])


], axis=1).to_csv("LC50_test_results.csv", index=False)
