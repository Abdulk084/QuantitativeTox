...
pred_test_ext_stack_load = np.squeeze(pred_test_ext_stack_load[2][1475:1833])


test_ext_IGC50_meta_r2 = np.array([test_ext_IGC50_meta_r2])


test_ext_IGC50_meta_mae = np.array([test_ext_IGC50_meta_mae])


test_ext_IGC50_meta_rmse = np.array([test_ext_IGC50_meta_rmse])
...
pd.concat([
    ...
    pd.DataFrame(pred_test_ext_stack_load, columns=['pred_test_ext_stack_load_IGC50']),

    pd.DataFrame(test_ext_IGC50_meta_r2, columns=['test_ext_IGC50_meta_r2']),

    pd.DataFrame(test_ext_IGC50_meta_mae, columns=['test_ext_IGC50_meta_mae']),

    pd.DataFrame(test_ext_IGC50_meta_rmse, columns=['test_ext_IGC50_meta_rmse'])


], axis=1).to_csv("IGC50_test_results.csv", index=False)
